...
<div class="container">
	<div class="page-header" align="center"><h1>Laporan Hasil Analisis Ekonomi</h1></div>
	<form action="tampilresultek.php" method="get">
		<label>Cari :</label>
	...
	<a class="btn btn-info btn-sm" href="cetakresultek.php" target="blank">Cetak</a>
	<a class="btn btn-info btn-sm" href="dashboard.php">Kembali</a>
	<a class="btn btn-info btn-sm" href="diagramek.php">Grafik</a>
