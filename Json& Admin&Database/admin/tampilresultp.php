...
<div class="container">
	<div class="page-header" align="center"><h1>Laporan Hasil Analisis Performance</h1></div>
	<form action="tampilresultp.php" method="get">
		<label>Cari :</label>
	...
	<a class="btn btn-info btn-sm" href="cetakresultp.php" target="blank">Cetak</a>
	<a class="btn btn-info btn-sm" href="dashboard.php">Kembali</a>
	<a class="btn btn-info btn-sm" href="diagramp.php">Grafik</a>
