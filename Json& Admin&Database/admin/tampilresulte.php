...
<div class="container">
	<div class="page-header" align="center"><h1>Laporan Hasil Analisis Efisien</h1></div>
	<form action="tampilresulte.php" method="get">
		<label>Cari :</label>
	...
	<a class="btn btn-info btn-sm" href="cetakresulte.php" target="blank">Cetak</a>
	<a class="btn btn-info btn-sm" href="dashboard.php">Kembali</a>
		<a class="btn btn-info btn-sm" href="diagrame.php">Grafik</a>
