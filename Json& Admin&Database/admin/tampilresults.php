...
<div class="container">
	<div class="page-header" align="center"><h1>Laporan Hasil Analisis Servis</h1></div>
	<form action="tampilresults.php" method="get">
		<label>Cari :</label>
	...
	<a class="btn btn-info btn-sm" href="cetakresults.php" target="blank">Cetak</a>
	<a class="btn btn-info btn-sm" href="dashboard.php">Kembali</a>
		<a class="btn btn-info btn-sm" href="diagrams.php">Grafik</a>
