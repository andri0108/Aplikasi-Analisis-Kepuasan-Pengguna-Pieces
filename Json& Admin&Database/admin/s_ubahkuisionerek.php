...
$koneksi=mysql_connect("localhost","id13818931_analisis1","t!smi9wo&sKgxu}D");
	...
	$simpan=mysql_query("update k_ekonomi set kuisioner='$kuisionerx' where id_kuisioner='$id_kuisionerx'");
	if($simpan){
	echo "<h4>berhasil disimpan</h4>";
	//header("location:tampilkuisionerek.php");
	include "tampilkuisionerek.php";
	}
?>
