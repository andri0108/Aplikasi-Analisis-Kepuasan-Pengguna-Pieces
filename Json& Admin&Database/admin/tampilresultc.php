...
<div class="container">
	<div class="page-header" align="center"><h1>Laporan Hasil Analisis Control</h1></div>
	<form action="tampilresultc.php" method="get">
		<label>Cari :</label>
	...
	<a class="btn btn-info btn-sm" href="cetakresultc.php" target="blank">Cetak</a>
	<a class="btn btn-info btn-sm" href="dashboard.php">Kembali</a>
	<a class="btn btn-info btn-sm" href="diagramc.php">Grafik</a>
