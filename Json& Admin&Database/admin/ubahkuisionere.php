 ...
 <?php
	$koneksi=mysql_connect("localhost","id13818931_analisis1","sipintar2t!smi9wo&sKgxu}D");
	mysql_select_db("id13818931_analisis",$koneksi);
	$isi=$_GET['id_kuisioner'];
	$cari=mysql_query("select * from k_efisien where id_kuisioner='$isi'");
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
									<form method="POST" action="s_ubahkuisionere.php" name="form1">
